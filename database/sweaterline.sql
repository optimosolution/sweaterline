...
MySQL - 5.6.21 : Database - sweaterline
*********************************************************************
*/
...
/*Data for the table `sl_address` */

/*Table structure for table `sl_affiliate` */

DROP TABLE IF EXISTS `sl_affiliate`;

CREATE TABLE `sl_affiliate` (
...
/*Data for the table `sl_affiliate` */

/*Table structure for table `sl_affiliate_activity` */

DROP TABLE IF EXISTS `sl_affiliate_activity`;

CREATE TABLE `sl_affiliate_activity` (
...
/*Data for the table `sl_affiliate_activity` */

/*Table structure for table `sl_affiliate_login` */

DROP TABLE IF EXISTS `sl_affiliate_login`;

CREATE TABLE `sl_affiliate_login` (
...
/*Data for the table `sl_affiliate_login` */

/*Table structure for table `sl_affiliate_transaction` */

DROP TABLE IF EXISTS `sl_affiliate_transaction`;

CREATE TABLE `sl_affiliate_transaction` (
...
/*Data for the table `sl_affiliate_transaction` */

/*Table structure for table `sl_api` */

DROP TABLE IF EXISTS `sl_api`;
...
/*Data for the table `sl_api` */

insert  into `sl_api`(`api_id`,`name`,`key`,`status`,`date_added`,`date_modified`) values (1,'Default','',1,'2017-04-11 21:30:57','2017-04-11 21:30:57');

/*Table structure for table `sl_api_ip` */

DROP TABLE IF EXISTS `sl_api_ip`;

CREATE TABLE `sl_api_ip` (
...
/*Data for the table `sl_api_ip` */

/*Table structure for table `sl_api_session` */

DROP TABLE IF EXISTS `sl_api_session`;

CREATE TABLE `sl_api_session` (
...
/*Data for the table `sl_api_session` */

/*Table structure for table `sl_attribute` */

DROP TABLE IF EXISTS `sl_attribute`;
...
/*Data for the table `sl_attribute` */

insert  into `sl_attribute`(`attribute_id`,`attribute_group_id`,`sort_order`) values (1,6,1),(2,6,5),(3,6,3),(4,3,1),(5,3,2),(6,3,3),(7,3,4),(8,3,5),(9,3,6),(10,3,7),(11,3,8);

/*Table structure for table `sl_attribute_description` */

DROP TABLE IF EXISTS `sl_attribute_description`;

CREATE TABLE `sl_attribute_description` (
...
/*Data for the table `sl_attribute_description` */

insert  into `sl_attribute_description`(`attribute_id`,`language_id`,`name`) values (1,1,'Description'),(2,1,'No. of Cores'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8'),(3,1,'Clockspeed');

/*Table structure for table `sl_attribute_group` */

DROP TABLE IF EXISTS `sl_attribute_group`;

CREATE TABLE `sl_attribute_group` (
  `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`attribute_group_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `sl_attribute_group` */

insert  into `sl_attribute_group`(`attribute_group_id`,`sort_order`) values (3,2),(4,1),(5,3),(6,4);

/*Table structure for table `sl_attribute_group_description` */

DROP TABLE IF EXISTS `sl_attribute_group_description`;

CREATE TABLE `sl_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `sl_attribute_group_description` */

insert  into `sl_attribute_group_description`(`attribute_group_id`,`language_id`,`name`) values (3,1,'Memory'),(4,1,'Technical'),(5,1,'Motherboard'),(6,1,'Processor');

/*Table structure for table `sl_banner` */
...
/*Data for the table `sl_banner` */

insert  into `sl_banner`(`banner_id`,`name`,`status`) values (6,'HP Products',1),(7,'Home Page Slideshow',1),(8,'Manufacturers',1);

/*Table structure for table `sl_banner_image` */

DROP TABLE IF EXISTS `sl_banner_image`;

CREATE TABLE `sl_banner_image` (
...
/*Data for the table `sl_banner_image` */

insert  into `sl_banner_image`(`banner_image_id`,`banner_id`,`language_id`,`title`,`link`,`image`,`sort_order`) values (79,7,1,'iPhone 6','index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),(87,6,1,'HP Banner','index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(94,8,1,'NFL','','catalog/demo/manufacturer/nfl.png',0),(95,8,1,'RedBull','','catalog/demo/manufacturer/redbull.png',0),(96,8,1,'Sony','','catalog/demo/manufacturer/sony.png',0),(91,8,1,'Coca Cola','','catalog/demo/manufacturer/cocacola.png',0),(92,8,1,'Burger King','','catalog/demo/manufacturer/burgerking.png',0),(93,8,1,'Canon','','catalog/demo/manufacturer/canon.png',0),(88,8,1,'Harley Davidson','','catalog/demo/manufacturer/harley.png',0),(89,8,1,'Dell','','catalog/demo/manufacturer/dell.png',0),(90,8,1,'Disney','','catalog/demo/manufacturer/disney.png',0),(80,7,1,'MacBookAir','','catalog/demo/banners/MacBookAir.jpg',0),(97,8,1,'Starbucks','','catalog/demo/manufacturer/starbucks.png',0),(98,8,1,'Nintendo','','catalog/demo/manufacturer/nintendo.png',0);

/*Table structure for table `sl_cart` */

DROP TABLE IF EXISTS `sl_cart`;

CREATE TABLE `sl_cart` (
...
/*Data for the table `sl_category_to_layout` */

/*Table structure for table `sl_category_to_store` */

DROP TABLE IF EXISTS `sl_category_to_store`;

CREATE TABLE `sl_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_category_to_store` */

insert  into `sl_category_to_store`(`category_id`,`store_id`) values (17,0),(18,0),(20,0),(24,0),(25,0),(26,0),(27,0),(28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(37,0),(38,0),(39,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0),(50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0);

/*Table structure for table `sl_country` */

DROP TABLE IF EXISTS `sl_country`;
...
/*Data for the table `sl_coupon` */

insert  into `sl_coupon`(`coupon_id`,`name`,`code`,`type`,`discount`,`logged`,`shipping`,`total`,`date_start`,`date_end`,`uses_total`,`uses_customer`,`status`,`date_added`) values (4,'-10% Discount','2222','P',10.0000,0,0,0.0000,'2014-01-01','2020-01-01',10,'10',0,'2009-01-27 13:55:03'),(5,'Free Shipping','3333','P',0.0000,0,1,100.0000,'2014-01-01','2014-02-01',10,'10',0,'2009-03-14 21:13:53'),(6,'-10.00 Discount','1111','F',10.0000,0,0,10.0000,'2014-01-01','2020-01-01',100000,'10000',0,'2009-03-14 21:15:18');

/*Table structure for table `sl_coupon_category` */

DROP TABLE IF EXISTS `sl_coupon_category`;

CREATE TABLE `sl_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`coupon_id`,`category_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_coupon_category` */

/*Table structure for table `sl_coupon_history` */

DROP TABLE IF EXISTS `sl_coupon_history`;

CREATE TABLE `sl_coupon_history` (
...
/*Data for the table `sl_coupon_history` */

/*Table structure for table `sl_coupon_product` */

DROP TABLE IF EXISTS `sl_coupon_product`;

CREATE TABLE `sl_coupon_product` (
...
/*Data for the table `sl_coupon_product` */
...
insert  into `sl_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.80110002,1,'2017-04-11 17:40:23'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2017-04-11 17:48:51'),(3,'Euro','EUR','','€','2',0.94120002,1,'2017-04-11 17:40:23');

/*Table structure for table `sl_custom_field` */

DROP TABLE IF EXISTS `sl_custom_field`;

CREATE TABLE `sl_custom_field` (
...
/*Data for the table `sl_custom_field` */

/*Table structure for table `sl_custom_field_customer_group` */

DROP TABLE IF EXISTS `sl_custom_field_customer_group`;

CREATE TABLE `sl_custom_field_customer_group` (
...
/*Data for the table `sl_custom_field_customer_group` */

/*Table structure for table `sl_custom_field_description` */

DROP TABLE IF EXISTS `sl_custom_field_description`;

CREATE TABLE `sl_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
/*Data for the table `sl_custom_field_description` */

/*Table structure for table `sl_custom_field_value` */

DROP TABLE IF EXISTS `sl_custom_field_value`;

CREATE TABLE `sl_custom_field_value` (
...
/*Data for the table `sl_custom_field_value` */

/*Table structure for table `sl_custom_field_value_description` */

DROP TABLE IF EXISTS `sl_custom_field_value_description`;

CREATE TABLE `sl_custom_field_value_description` (
...
/*Data for the table `sl_custom_field_value_description` */

/*Table structure for table `sl_customer` */
...
/*Data for the table `sl_customer` */

/*Table structure for table `sl_customer_activity` */

DROP TABLE IF EXISTS `sl_customer_activity`;

CREATE TABLE `sl_customer_activity` (
...
/*Data for the table `sl_customer_activity` */

/*Table structure for table `sl_customer_group` */

DROP TABLE IF EXISTS `sl_customer_group`;

CREATE TABLE `sl_customer_group` (
...
/*Data for the table `sl_customer_group` */

insert  into `sl_customer_group`(`customer_group_id`,`approval`,`sort_order`) values (1,0,1);

/*Table structure for table `sl_customer_group_description` */

DROP TABLE IF EXISTS `sl_customer_group_description`;

CREATE TABLE `sl_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
/*Data for the table `sl_customer_group_description` */

insert  into `sl_customer_group_description`(`customer_group_id`,`language_id`,`name`,`description`) values (1,1,'Default','test');

/*Table structure for table `sl_customer_history` */

DROP TABLE IF EXISTS `sl_customer_history`;

CREATE TABLE `sl_customer_history` (
...
/*Data for the table `sl_customer_history` */

/*Table structure for table `sl_customer_ip` */

DROP TABLE IF EXISTS `sl_customer_ip`;

CREATE TABLE `sl_customer_ip` (
...
/*Data for the table `sl_customer_ip` */

/*Table structure for table `sl_customer_login` */

DROP TABLE IF EXISTS `sl_customer_login`;

CREATE TABLE `sl_customer_login` (
...
/*Data for the table `sl_customer_login` */

/*Table structure for table `sl_customer_online` */

DROP TABLE IF EXISTS `sl_customer_online`;

CREATE TABLE `sl_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
/*Data for the table `sl_customer_online` */

/*Table structure for table `sl_customer_reward` */

DROP TABLE IF EXISTS `sl_customer_reward`;

CREATE TABLE `sl_customer_reward` (
...
/*Data for the table `sl_customer_reward` */

/*Table structure for table `sl_customer_search` */

DROP TABLE IF EXISTS `sl_customer_search`;

CREATE TABLE `sl_customer_search` (
...
/*Data for the table `sl_customer_search` */

/*Table structure for table `sl_customer_transaction` */

DROP TABLE IF EXISTS `sl_customer_transaction`;

CREATE TABLE `sl_customer_transaction` (
...
/*Data for the table `sl_customer_transaction` */

/*Table structure for table `sl_customer_wishlist` */

DROP TABLE IF EXISTS `sl_customer_wishlist`;

CREATE TABLE `sl_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
/*Data for the table `sl_customer_wishlist` */

/*Table structure for table `sl_download` */
...
/*Data for the table `sl_download` */

/*Table structure for table `sl_download_description` */

DROP TABLE IF EXISTS `sl_download_description`;

CREATE TABLE `sl_download_description` (
...
/*Data for the table `sl_download_description` */
...
/*Data for the table `sl_event` */

insert  into `sl_event`(`event_id`,`code`,`trigger`,`action`,`status`,`date_added`) values (1,'voucher','catalog/model/checkout/order/addOrderHistory/after','extension/total/voucher/send',0,'0000-00-00 00:00:00');

/*Table structure for table `sl_extension` */
...
/*Data for the table `sl_filter` */

/*Table structure for table `sl_filter_description` */

DROP TABLE IF EXISTS `sl_filter_description`;

CREATE TABLE `sl_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `sl_filter_description` */

/*Table structure for table `sl_filter_group` */

DROP TABLE IF EXISTS `sl_filter_group`;

CREATE TABLE `sl_filter_group` (
  `filter_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`filter_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_filter_group` */

/*Table structure for table `sl_filter_group_description` */

DROP TABLE IF EXISTS `sl_filter_group_description`;

CREATE TABLE `sl_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `sl_filter_group_description` */

/*Table structure for table `sl_geo_zone` */

DROP TABLE IF EXISTS `sl_geo_zone`;

CREATE TABLE `sl_geo_zone` (
...
/*Data for the table `sl_geo_zone` */

insert  into `sl_geo_zone`(`geo_zone_id`,`name`,`description`,`date_modified`,`date_added`) values (3,'UK VAT Zone','UK VAT','2010-02-26 22:33:24','2009-01-06 23:26:25'),(4,'UK Shipping','UK Shipping Zones','2010-12-15 15:18:13','2009-06-23 01:14:53');

/*Table structure for table `sl_information` */

DROP TABLE IF EXISTS `sl_information`;

CREATE TABLE `sl_information` (
...
/*Data for the table `sl_information` */

insert  into `sl_information`(`information_id`,`bottom`,`sort_order`,`status`) values (3,1,3,1),(4,1,1,1),(5,1,4,1),(6,1,2,1);

/*Table structure for table `sl_information_description` */

DROP TABLE IF EXISTS `sl_information_description`;

CREATE TABLE `sl_information_description` (
...
/*Data for the table `sl_information_description` */

insert  into `sl_information_description`(`information_id`,`language_id`,`title`,`description`,`meta_title`,`meta_description`,`meta_keyword`) values (4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),(5,1,'Terms &amp; Conditions','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Terms &amp; Conditions','',''),(3,1,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','',''),(6,1,'Delivery Information','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','Delivery Information','','');

/*Table structure for table `sl_information_to_layout` */

DROP TABLE IF EXISTS `sl_information_to_layout`;

CREATE TABLE `sl_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
/*Data for the table `sl_information_to_layout` */

/*Table structure for table `sl_information_to_store` */

DROP TABLE IF EXISTS `sl_information_to_store`;

CREATE TABLE `sl_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_information_to_store` */

insert  into `sl_information_to_store`(`information_id`,`store_id`) values (3,0),(4,0),(5,0),(6,0);

/*Table structure for table `sl_language` */

DROP TABLE IF EXISTS `sl_language`;
...
/*Data for the table `sl_language` */

insert  into `sl_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`sort_order`,`status`) values (1,'English','en-gb','en-US,en_US.UTF-8,en_US,en-gb,english','gb.png','english',1,1);

/*Table structure for table `sl_layout` */

DROP TABLE IF EXISTS `sl_layout`;

CREATE TABLE `sl_layout` (
  `layout_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  PRIMARY KEY (`layout_id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

/*Data for the table `sl_layout` */

insert  into `sl_layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search');

/*Table structure for table `sl_layout_module` */

DROP TABLE IF EXISTS `sl_layout_module`;

CREATE TABLE `sl_layout_module` (
...
/*Data for the table `sl_layout_module` */

insert  into `sl_layout_module`(`layout_module_id`,`layout_id`,`code`,`position`,`sort_order`) values (2,4,'0','content_top',0),(3,4,'0','content_top',1),(20,5,'0','column_left',2),(69,10,'affiliate','column_right',1),(68,6,'account','column_right',1),(67,1,'carousel.29','content_top',3),(66,1,'slideshow.27','content_top',1),(65,1,'featured.28','content_top',2),(72,3,'category','column_left',1),(73,3,'banner.30','column_left',2);

/*Table structure for table `sl_layout_route` */

DROP TABLE IF EXISTS `sl_layout_route`;

CREATE TABLE `sl_layout_route` (
...
/*Data for the table `sl_layout_route` */

insert  into `sl_layout_route`(`layout_route_id`,`layout_id`,`store_id`,`route`) values (38,6,0,'account/%'),(17,10,0,'affiliate/%'),(44,3,0,'product/category'),(42,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(23,7,0,'checkout/%'),(31,8,0,'information/contact'),(32,9,0,'information/sitemap'),(34,4,0,''),(45,5,0,'product/manufacturer'),(52,12,0,'product/compare'),(53,13,0,'product/search');

/*Table structure for table `sl_length_class` */

DROP TABLE IF EXISTS `sl_length_class`;

CREATE TABLE `sl_length_class` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL,
  PRIMARY KEY (`length_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `sl_length_class` */

insert  into `sl_length_class`(`length_class_id`,`value`) values (1,1.00000000),(2,10.00000000),(3,0.39370000);

/*Table structure for table `sl_length_class_description` */

DROP TABLE IF EXISTS `sl_length_class_description`;

CREATE TABLE `sl_length_class_description` (
...
/*Data for the table `sl_length_class_description` */

insert  into `sl_length_class_description`(`length_class_id`,`language_id`,`title`,`unit`) values (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in');
...
DROP TABLE IF EXISTS `sl_manufacturer`;
...
/*Data for the table `sl_manufacturer` */

insert  into `sl_manufacturer`(`manufacturer_id`,`name`,`image`,`sort_order`) values (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'Hewlett-Packard','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);

/*Table structure for table `sl_manufacturer_to_store` */

DROP TABLE IF EXISTS `sl_manufacturer_to_store`;

CREATE TABLE `sl_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`manufacturer_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_manufacturer_to_store` */

insert  into `sl_manufacturer_to_store`(`manufacturer_id`,`store_id`) values (5,0),(6,0),(7,0),(8,0),(9,0),(10,0);

/*Table structure for table `sl_marketing` */

DROP TABLE IF EXISTS `sl_marketing`;

CREATE TABLE `sl_marketing` (
...
/*Data for the table `sl_marketing` */
...
/*Table structure for table `sl_menu_description` */

DROP TABLE IF EXISTS `sl_menu_description`;

CREATE TABLE `sl_menu_description` (
...
/*Data for the table `sl_menu_description` */

/*Table structure for table `sl_menu_module` */

DROP TABLE IF EXISTS `sl_menu_module`;

CREATE TABLE `sl_menu_module` (
...
/*Data for the table `sl_menu_module` */

/*Table structure for table `sl_modification` */

DROP TABLE IF EXISTS `sl_modification`;

CREATE TABLE `sl_modification` (
...
/*Data for the table `sl_modification` */

/*Table structure for table `sl_module` */
...
/*Data for the table `sl_option` */

insert  into `sl_option`(`option_id`,`type`,`sort_order`) values (1,'radio',1),(2,'checkbox',2),(4,'text',3),(5,'select',4),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',10),(12,'date',11);

/*Table structure for table `sl_option_description` */

DROP TABLE IF EXISTS `sl_option_description`;

CREATE TABLE `sl_option_description` (
...
/*Data for the table `sl_option_description` */

insert  into `sl_option_description`(`option_id`,`language_id`,`name`) values (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size');

/*Table structure for table `sl_option_value` */

DROP TABLE IF EXISTS `sl_option_value`;

CREATE TABLE `sl_option_value` (
...
/*Data for the table `sl_option_value` */

insert  into `sl_option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3);

/*Table structure for table `sl_option_value_description` */

DROP TABLE IF EXISTS `sl_option_value_description`;

CREATE TABLE `sl_option_value_description` (
...
/*Data for the table `sl_option_value_description` */

insert  into `sl_option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small');
...
/*Data for the table `sl_order` */

/*Table structure for table `sl_order_custom_field` */

DROP TABLE IF EXISTS `sl_order_custom_field`;

CREATE TABLE `sl_order_custom_field` (
...
/*Data for the table `sl_order_custom_field` */

/*Table structure for table `sl_order_history` */

DROP TABLE IF EXISTS `sl_order_history`;

CREATE TABLE `sl_order_history` (
...
/*Data for the table `sl_order_history` */

/*Table structure for table `sl_order_option` */

DROP TABLE IF EXISTS `sl_order_option`;

CREATE TABLE `sl_order_option` (
...
/*Data for the table `sl_order_option` */

/*Table structure for table `sl_order_product` */

DROP TABLE IF EXISTS `sl_order_product`;

CREATE TABLE `sl_order_product` (
...
/*Data for the table `sl_order_product` */

/*Table structure for table `sl_order_recurring` */

DROP TABLE IF EXISTS `sl_order_recurring`;

CREATE TABLE `sl_order_recurring` (
...
/*Data for the table `sl_order_recurring` */

/*Table structure for table `sl_order_recurring_transaction` */

DROP TABLE IF EXISTS `sl_order_recurring_transaction`;

CREATE TABLE `sl_order_recurring_transaction` (
...
/*Data for the table `sl_order_recurring_transaction` */

/*Table structure for table `sl_order_status` */

DROP TABLE IF EXISTS `sl_order_status`;

CREATE TABLE `sl_order_status` (
...
/*Data for the table `sl_order_status` */

insert  into `sl_order_status`(`order_status_id`,`language_id`,`name`) values (2,1,'Processing'),(3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(11,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(1,1,'Pending'),(16,1,'Voided'),(15,1,'Processed'),(14,1,'Expired');

/*Table structure for table `sl_order_total` */

DROP TABLE IF EXISTS `sl_order_total`;

CREATE TABLE `sl_order_total` (
...
/*Data for the table `sl_order_total` */

/*Table structure for table `sl_order_voucher` */

DROP TABLE IF EXISTS `sl_order_voucher`;

CREATE TABLE `sl_order_voucher` (
...
/*Data for the table `sl_order_voucher` */
...
/*Data for the table `sl_product_attribute` */

insert  into `sl_product_attribute`(`product_id`,`attribute_id`,`language_id`,`text`) values (43,2,1,'1'),(47,4,1,'16GB'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,2,1,'4');

/*Table structure for table `sl_product_description` */

DROP TABLE IF EXISTS `sl_product_description`;

CREATE TABLE `sl_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
/*Data for the table `sl_product_discount` */

insert  into `sl_product_discount`(`product_discount_id`,`product_id`,`customer_group_id`,`quantity`,`priority`,`price`,`date_start`,`date_end`) values (440,42,1,30,1,66.0000,'0000-00-00','0000-00-00'),(439,42,1,20,1,77.0000,'0000-00-00','0000-00-00'),(438,42,1,10,1,88.0000,'0000-00-00','0000-00-00');

/*Table structure for table `sl_product_filter` */

DROP TABLE IF EXISTS `sl_product_filter`;

CREATE TABLE `sl_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`filter_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_product_filter` */

/*Table structure for table `sl_product_image` */
...
/*Data for the table `sl_product_option` */

insert  into `sl_product_option`(`product_option_id`,`product_id`,`option_id`,`value`,`required`) values (224,35,11,'',1),(225,47,12,'2011-04-22',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'test',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(221,42,9,'22:25',1),(220,42,10,'2011-02-20 22:25',1),(226,30,5,'',1);

/*Table structure for table `sl_product_option_value` */

DROP TABLE IF EXISTS `sl_product_option_value`;

CREATE TABLE `sl_product_option_value` (
...
/*Data for the table `sl_product_recurring` */

/*Table structure for table `sl_product_related` */

DROP TABLE IF EXISTS `sl_product_related`;

CREATE TABLE `sl_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`related_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_product_related` */

insert  into `sl_product_related`(`product_id`,`related_id`) values (40,42),(41,42),(42,40),(42,41);

/*Table structure for table `sl_product_reward` */

DROP TABLE IF EXISTS `sl_product_reward`;

CREATE TABLE `sl_product_reward` (
...
/*Data for the table `sl_product_reward` */

insert  into `sl_product_reward`(`product_reward_id`,`product_id`,`customer_group_id`,`points`) values (515,42,1,100),(519,47,1,300),(379,28,1,400),(329,43,1,600),(339,29,1,0),(343,48,1,0),(335,40,1,0),(539,30,1,200),(331,44,1,700),(333,45,1,800),(337,31,1,0),(425,35,1,0),(345,33,1,0),(347,46,1,0),(545,41,1,0),(351,36,1,0),(353,34,1,0),(355,32,1,0),(521,49,1,1000);

/*Table structure for table `sl_product_special` */

DROP TABLE IF EXISTS `sl_product_special`;

CREATE TABLE `sl_product_special` (
...
/*Data for the table `sl_product_special` */

insert  into `sl_product_special`(`product_special_id`,`product_id`,`customer_group_id`,`priority`,`price`,`date_start`,`date_end`) values (419,42,1,1,90.0000,'0000-00-00','0000-00-00'),(439,30,1,2,90.0000,'0000-00-00','0000-00-00'),(438,30,1,1,80.0000,'0000-00-00','0000-00-00');

/*Table structure for table `sl_product_to_category` */

DROP TABLE IF EXISTS `sl_product_to_category`;

CREATE TABLE `sl_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
/*Data for the table `sl_product_to_category` */

insert  into `sl_product_to_category`(`product_id`,`category_id`) values (28,20),(28,24),(29,20),(29,24),(30,20),(30,33),(31,33),(32,34),(33,20),(33,28),(34,34),(35,20),(36,34),(40,20),(40,24),(41,27),(42,20),(42,28),(43,18),(43,20),(44,18),(44,20),(45,18),(46,18),(46,20),(47,18),(47,20),(48,20),(48,34),(49,57);

/*Table structure for table `sl_product_to_download` */

DROP TABLE IF EXISTS `sl_product_to_download`;

CREATE TABLE `sl_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`download_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_product_to_download` */

/*Table structure for table `sl_product_to_layout` */

DROP TABLE IF EXISTS `sl_product_to_layout`;

CREATE TABLE `sl_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
/*Data for the table `sl_product_to_layout` */

/*Table structure for table `sl_product_to_store` */

DROP TABLE IF EXISTS `sl_product_to_store`;

CREATE TABLE `sl_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_product_to_store` */

insert  into `sl_product_to_store`(`product_id`,`store_id`) values (28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0);

/*Table structure for table `sl_recurring` */

DROP TABLE IF EXISTS `sl_recurring`;
...
/*Data for the table `sl_recurring` */

/*Table structure for table `sl_recurring_description` */

DROP TABLE IF EXISTS `sl_recurring_description`;

CREATE TABLE `sl_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
/*Data for the table `sl_recurring_description` */
...
/*Data for the table `sl_return` */

/*Table structure for table `sl_return_action` */

DROP TABLE IF EXISTS `sl_return_action`;

CREATE TABLE `sl_return_action` (
...
/*Data for the table `sl_return_action` */

insert  into `sl_return_action`(`return_action_id`,`language_id`,`name`) values (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent');

/*Table structure for table `sl_return_history` */

DROP TABLE IF EXISTS `sl_return_history`;

CREATE TABLE `sl_return_history` (
...
/*Data for the table `sl_return_history` */

/*Table structure for table `sl_return_reason` */

DROP TABLE IF EXISTS `sl_return_reason`;

CREATE TABLE `sl_return_reason` (
...
/*Data for the table `sl_return_reason` */

insert  into `sl_return_reason`(`return_reason_id`,`language_id`,`name`) values (1,1,'Dead On Arrival'),(2,1,'Received Wrong Item'),(3,1,'Order Error'),(4,1,'Faulty, please supply details'),(5,1,'Other, please supply details');

/*Table structure for table `sl_return_status` */

DROP TABLE IF EXISTS `sl_return_status`;

CREATE TABLE `sl_return_status` (
...
/*Data for the table `sl_return_status` */

insert  into `sl_return_status`(`return_status_id`,`language_id`,`name`) values (1,1,'Pending'),(3,1,'Complete'),(2,1,'Awaiting Products');

/*Table structure for table `sl_review` */

DROP TABLE IF EXISTS `sl_review`;
...
insert  into `sl_setting`(`setting_id`,`store_id`,`code`,`key`,`value`,`serialized`) values (539,0,'config','config_error_log','1',0),(538,0,'config','config_error_display','1',0),(537,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf',0),(536,0,'config','config_file_ext_allowed','zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc',0),(535,0,'config','config_file_max_size','300000',0),(530,0,'config','config_compression','0',0),(531,0,'config','config_secure','0',0),(532,0,'config','config_password','1',0),(533,0,'config','config_shared','0',0),(534,0,'config','config_encryption','',0),(4,0,'voucher','voucher_sort_order','8',0),(5,0,'voucher','voucher_status','1',0),(506,0,'config','config_return_id','0',0),(507,0,'config','config_return_status_id','2',0),(508,0,'config','config_captcha','',0),(509,0,'config','config_captcha_page','[\"review\",\"return\",\"contact\"]',1),(510,0,'config','config_logo','catalog/logo.png',0),(511,0,'config','config_icon','catalog/cart.png',0),(512,0,'config','config_ftp_hostname','localhost:8888',0),(513,0,'config','config_ftp_port','21',0),(514,0,'config','config_ftp_username','',0),(515,0,'config','config_ftp_password','',0),(516,0,'config','config_ftp_root','',0),(517,0,'config','config_ftp_status','0',0),(518,0,'config','config_mail_protocol','mail',0),(519,0,'config','config_mail_parameter','',0),(520,0,'config','config_mail_smtp_hostname','',0),(521,0,'config','config_mail_smtp_username','',0),(522,0,'config','config_mail_smtp_password','',0),(523,0,'config','config_mail_smtp_port','25',0),(524,0,'config','config_mail_smtp_timeout','5',0),(525,0,'config','config_mail_alert','[\"order\"]',1),(526,0,'config','config_mail_alert_email','',0),(527,0,'config','config_maintenance','0',0),(528,0,'config','config_seo_url','0',0),(529,0,'config','config_robots','abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg',0),(505,0,'config','config_affiliate_id','4',0),(504,0,'config','config_affiliate_commission','5',0),(503,0,'config','config_affiliate_auto','0',0),(497,0,'config','config_fraud_status_id','7',0),(498,0,'config','config_api_id','1',0),(499,0,'config','config_stock_display','0',0),(500,0,'config','config_stock_warning','0',0),(501,0,'config','config_stock_checkout','0',0),(502,0,'config','config_affiliate_approval','0',0),(95,0,'free_checkout','free_checkout_status','1',0),(96,0,'free_checkout','free_checkout_order_status_id','1',0),(97,0,'shipping','shipping_sort_order','3',0),(98,0,'sub_total','sub_total_sort_order','1',0),(99,0,'sub_total','sub_total_status','1',0),(100,0,'tax','tax_status','1',0),(101,0,'total','total_sort_order','9',0),(102,0,'total','total_status','1',0),(103,0,'tax','tax_sort_order','5',0),(104,0,'free_checkout','free_checkout_sort_order','1',0),(105,0,'cod','cod_sort_order','5',0),(106,0,'cod','cod_total','0.01',0),(107,0,'cod','cod_order_status_id','1',0),(108,0,'cod','cod_geo_zone_id','0',0),(109,0,'cod','cod_status','1',0),(110,0,'shipping','shipping_status','1',0),(111,0,'shipping','shipping_estimator','1',0),(112,0,'coupon','coupon_sort_order','4',0),(113,0,'coupon','coupon_status','1',0),(114,0,'flat','flat_sort_order','1',0),(115,0,'flat','flat_status','1',0),(116,0,'flat','flat_geo_zone_id','0',0),(117,0,'flat','flat_tax_class_id','9',0),(118,0,'flat','flat_cost','5.00',0),(119,0,'credit','credit_sort_order','7',0),(120,0,'credit','credit_status','1',0),(121,0,'reward','reward_sort_order','2',0),(122,0,'reward','reward_status','1',0),(123,0,'category','category_status','1',0),(124,0,'account','account_status','1',0),(125,0,'affiliate','affiliate_status','1',0),(126,0,'theme_default','theme_default_product_limit','15',0),(127,0,'theme_default','theme_default_product_description_length','100',0),(128,0,'theme_default','theme_default_image_thumb_width','228',0),(129,0,'theme_default','theme_default_image_thumb_height','228',0),(130,0,'theme_default','theme_default_image_popup_width','500',0),(131,0,'theme_default','theme_default_image_popup_height','500',0),(132,0,'theme_default','theme_default_image_category_width','80',0),(133,0,'theme_default','theme_default_image_category_height','80',0),(134,0,'theme_default','theme_default_image_product_width','228',0),(135,0,'theme_default','theme_default_image_product_height','228',0),(136,0,'theme_default','theme_default_image_additional_width','74',0),(137,0,'theme_default','theme_default_image_additional_height','74',0),(138,0,'theme_default','theme_default_image_related_width','200',0),(139,0,'theme_default','theme_default_image_related_height','200',0),(140,0,'theme_default','theme_default_image_compare_width','90',0),(141,0,'theme_default','theme_default_image_compare_height','90',0),(142,0,'theme_default','theme_default_image_wishlist_width','47',0),(143,0,'theme_default','theme_default_image_wishlist_height','47',0),(144,0,'theme_default','theme_default_image_cart_height','47',0),(145,0,'theme_default','theme_default_image_cart_width','47',0),(146,0,'theme_default','theme_default_image_location_height','50',0),(147,0,'theme_default','theme_default_image_location_width','268',0),(148,0,'theme_default','theme_default_directory','default',0),(149,0,'theme_default','theme_default_status','1',0),(150,0,'dashboard_activity','dashboard_activity_status','1',0),(151,0,'dashboard_activity','dashboard_activity_sort_order','7',0),(152,0,'dashboard_sale','dashboard_sale_status','1',0),(153,0,'dashboard_sale','dashboard_sale_width','3',0),(154,0,'dashboard_chart','dashboard_chart_status','1',0),(155,0,'dashboard_chart','dashboard_chart_width','6',0),(156,0,'dashboard_customer','dashboard_customer_status','1',0),(157,0,'dashboard_customer','dashboard_customer_width','3',0),(158,0,'dashboard_map','dashboard_map_status','1',0),(159,0,'dashboard_map','dashboard_map_width','6',0),(160,0,'dashboard_online','dashboard_online_status','1',0),(161,0,'dashboard_online','dashboard_online_width','3',0),(162,0,'dashboard_order','dashboard_order_sort_order','1',0),(163,0,'dashboard_order','dashboard_order_status','1',0),(164,0,'dashboard_order','dashboard_order_width','3',0),(165,0,'dashboard_sale','dashboard_sale_sort_order','2',0),(166,0,'dashboard_customer','dashboard_customer_sort_order','3',0),(167,0,'dashboard_online','dashboard_online_sort_order','4',0),(168,0,'dashboard_map','dashboard_map_sort_order','5',0),(169,0,'dashboard_chart','dashboard_chart_sort_order','6',0),(170,0,'dashboard_recent','dashboard_recent_status','1',0),(171,0,'dashboard_recent','dashboard_recent_sort_order','8',0),(172,0,'dashboard_activity','dashboard_activity_width','4',0),(173,0,'dashboard_recent','dashboard_recent_width','8',0),(496,0,'config','config_complete_status','[\"5\",\"3\"]',1),(495,0,'config','config_processing_status','[\"5\",\"1\",\"2\",\"12\",\"3\"]',1),(494,0,'config','config_order_status_id','1',0),(493,0,'config','config_checkout_id','5',0),(492,0,'config','config_checkout_guest','1',0),(491,0,'config','config_cart_weight','1',0),(490,0,'config','config_invoice_prefix','INV-2013-00',0),(489,0,'config','config_account_id','3',0),(488,0,'config','config_login_attempts','5',0),(487,0,'config','config_customer_price','0',0),(486,0,'config','config_customer_group_display','[\"1\"]',1),(485,0,'config','config_customer_group_id','1',0),(484,0,'config','config_customer_search','0',0),(483,0,'config','config_customer_activity','0',0),(482,0,'config','config_customer_online','0',0),(481,0,'config','config_tax_customer','shipping',0),(480,0,'config','config_tax_default','shipping',0),(479,0,'config','config_tax','1',0),(478,0,'config','config_voucher_max','1000',0),(477,0,'config','config_voucher_min','1',0),(476,0,'config','config_review_guest','1',0),(475,0,'config','config_review_status','1',0),(474,0,'config','config_limit_admin','20',0),(473,0,'config','config_product_count','1',0),(472,0,'config','config_weight_class_id','1',0),(471,0,'config','config_length_class_id','1',0),(470,0,'config','config_currency_auto','1',0),(469,0,'config','config_currency','USD',0),(468,0,'config','config_admin_language','en-gb',0),(467,0,'config','config_language','en-gb',0),(466,0,'config','config_zone_id','322',0),(465,0,'config','config_country_id','18',0),(464,0,'config','config_comment','',0),(463,0,'config','config_open','',0),(462,0,'config','config_image','',0),(461,0,'config','config_fax','',0),(459,0,'config','config_email','otlservice24@gmail.com',0),(460,0,'config','config_telephone','8801721133500',0),(458,0,'config','config_geocode','',0),(457,0,'config','config_address','KA/59 Kuratoli, Khilkhet, Dhaka, Bangladesh',0),(456,0,'config','config_owner','Mohammed Arif Hossain',0),(455,0,'config','config_name','Sweaterline.com',0),(454,0,'config','config_layout_id','4',0),(453,0,'config','config_theme','theme_default',0),(452,0,'config','config_meta_keyword','',0),(451,0,'config','config_meta_description','',0),(450,0,'config','config_meta_title','Sweaterline.com',0),(540,0,'config','config_error_filename','error.log',0);

/*Table structure for table `sl_stock_status` */

DROP TABLE IF EXISTS `sl_stock_status`;

CREATE TABLE `sl_stock_status` (
...
/*Data for the table `sl_stock_status` */

insert  into `sl_stock_status`(`stock_status_id`,`language_id`,`name`) values (7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock'),(6,1,'2-3 Days');
...
/*Data for the table `sl_store` */

/*Table structure for table `sl_tax_class` */

DROP TABLE IF EXISTS `sl_tax_class`;

CREATE TABLE `sl_tax_class` (
...
/*Data for the table `sl_tax_class` */

insert  into `sl_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');

/*Table structure for table `sl_tax_rate` */

DROP TABLE IF EXISTS `sl_tax_rate`;

CREATE TABLE `sl_tax_rate` (
...
/*Data for the table `sl_tax_rate` */

insert  into `sl_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (20%)',20.0000,'P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)',2.0000,'F','2011-09-21 21:49:23','2011-09-23 00:40:19');

/*Table structure for table `sl_tax_rate_to_customer_group` */

DROP TABLE IF EXISTS `sl_tax_rate_to_customer_group`;

CREATE TABLE `sl_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`tax_rate_id`,`customer_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `sl_tax_rate_to_customer_group` */

insert  into `sl_tax_rate_to_customer_group`(`tax_rate_id`,`customer_group_id`) values (86,1),(87,1);

/*Table structure for table `sl_tax_rule` */

DROP TABLE IF EXISTS `sl_tax_rule`;

CREATE TABLE `sl_tax_rule` (
...
/*Data for the table `sl_tax_rule` */

insert  into `sl_tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);

/*Table structure for table `sl_theme` */

DROP TABLE IF EXISTS `sl_theme`;

CREATE TABLE `sl_theme` (
...
/*Data for the table `sl_theme` */

/*Table structure for table `sl_translation` */

DROP TABLE IF EXISTS `sl_translation`;

CREATE TABLE `sl_translation` (
...
/*Data for the table `sl_translation` */

/*Table structure for table `sl_upload` */

DROP TABLE IF EXISTS `sl_upload`;

CREATE TABLE `sl_upload` (
...
/*Data for the table `sl_upload` */

/*Table structure for table `sl_url_alias` */

DROP TABLE IF EXISTS `sl_url_alias`;

CREATE TABLE `sl_url_alias` (
...
insert  into `sl_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','b0cbea1ce3a42f8a8e2f2b6c47def1e0dde4175d','yZ81tu42y','Optimo','Solution ','optimosolution@gmail.com','','','::1',1,'2017-04-11 21:30:57'),(2,1,'arif','01d3b4b4b98284f6c325589781222ad1ab718268','ZToHj0Vyq','Mohammed Arif','Hossain','otlservice24@gmail.com','','','',1,'2017-04-11 21:48:44');

/*Table structure for table `sl_user_group` */

DROP TABLE IF EXISTS `sl_user_group`;

CREATE TABLE `sl_user_group` (
...
/*Data for the table `sl_voucher` */

/*Table structure for table `sl_voucher_history` */

DROP TABLE IF EXISTS `sl_voucher_history`;

CREATE TABLE `sl_voucher_history` (
...
/*Data for the table `sl_voucher_history` */

/*Table structure for table `sl_voucher_theme` */

DROP TABLE IF EXISTS `sl_voucher_theme`;

CREATE TABLE `sl_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) NOT NULL,
  PRIMARY KEY (`voucher_theme_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `sl_voucher_theme` */

insert  into `sl_voucher_theme`(`voucher_theme_id`,`image`) values (8,'catalog/demo/canon_eos_5d_2.jpg'),(7,'catalog/demo/gift-voucher-birthday.jpg'),(6,'catalog/demo/apple_logo.jpg');

/*Table structure for table `sl_voucher_theme_description` */

DROP TABLE IF EXISTS `sl_voucher_theme_description`;

CREATE TABLE `sl_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
/*Data for the table `sl_voucher_theme_description` */

insert  into `sl_voucher_theme_description`(`voucher_theme_id`,`language_id`,`name`) values (6,1,'Christmas'),(7,1,'Birthday'),(8,1,'General');

/*Table structure for table `sl_weight_class` */

DROP TABLE IF EXISTS `sl_weight_class`;

CREATE TABLE `sl_weight_class` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`weight_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `sl_weight_class` */

insert  into `sl_weight_class`(`weight_class_id`,`value`) values (1,1.00000000),(2,1000.00000000),(5,2.20460000),(6,35.27400000);

/*Table structure for table `sl_weight_class_description` */

DROP TABLE IF EXISTS `sl_weight_class_description`;

CREATE TABLE `sl_weight_class_description` (
...
/*Data for the table `sl_weight_class_description` */

insert  into `sl_weight_class_description`(`weight_class_id`,`language_id`,`title`,`unit`) values (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz');

/*Table structure for table `sl_zone` */

DROP TABLE IF EXISTS `sl_zone`;

CREATE TABLE `sl_zone` (
